...
public class Tempo {
    ...
    public void manipDataHora(String data){
        ...
        try{
            ...
            Gson gson = new Gson();
            br.com.usinasantafe.pru.to.tb.estaticas.DataHoraBean dataHoraBean = gson.fromJson(objeto.toString(), br.com.usinasantafe.pru.to.tb.estaticas.DataHoraBean.class);
                ...
                handler.post(new Runnable() {
                    public void run() {
                        ...
                        if(isEnvioDado()){
                            ...
                            setEnvioDado(EnvioDadosServ.getInstance().verifDadosEnvio());
                            if(isEnvioDado()){
                                Log.i("ECM", "ENVIANDO");
                                EnvioDadosServ.getInstance().envioDados(Tempo.getInstance().context);
                            }
                        }
                    }
                });
